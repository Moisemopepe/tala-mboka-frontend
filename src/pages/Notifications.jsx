    ...
    return (
      <div className="mx-auto flex min-h-[60vh] w-full max-w-2xl items-center justify-center">
        <Card className="w-full p-6 text-center">
          ...
          <h1 className="mt-4 font-heading text-2xl font-black text-text">Notifications</h1>
  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <p className="text-xs font-black uppercase tracking-[0.3em] text-primary">Notifications</p>
          <h1 className="font-heading text-2xl font-black text-text md:text-3xl">Mises à jour</h1>
          <p className="mt-1 text-sm font-semibold text-slate-500">
            Consultez les annonces, corrections et informations importantes.
          </p>
        </div>
      ...
      <Card className="overflow-hidden">
        <div className="flex items-center justify-between border-b border-slate-100 p-4">
          <div>
            <p className="font-heading text-lg font-black text-text">Toutes les notifications</p>
        ...
        {!loading && items.length === 0 && !error && (
          <div className="p-8 text-center">
            ...
            <p className="mt-3 font-heading text-lg font-black text-text">Aucune notification</p>
            <p className="mt-1 text-sm font-semibold text-slate-500">Les prochaines mises à jour apparaîtront ici.</p>
          </div>
        )}
